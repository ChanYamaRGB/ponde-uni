...
2: [ // 東方Project ======================================================================
  "最終鬼畜妹フランドール・S (原口沙輔は鬼畜なのか？remix)",
  "A-Yah-YAh-YaH-YAH!",
  "アマノジャクリバース feat. ｙｔｒ",
  "The Music of Violent Eating",
  "New World",
  "メイドノココロハアヤツリドール",
  "Ultimate taste",
  "Idoratrize World",
  ...
  "Pump!n",
  "Endless Seeker",
  "STRIPES feat. EL.J (2018 reinterpretation)",
  ...
  "Grip & Break down !!",
  "チルノおかんのさいきょう☆バイブスごはん",
  "つるぺったん",
  "Scream out! -CHUNITHM Tuning-",
  "Floating Darkness",
  "Spring of Dreams",
  "星色夜空",
  "物凄い勢いでけーねが物凄いうた",
